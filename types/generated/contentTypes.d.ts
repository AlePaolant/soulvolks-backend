...
export interface ApiArticoloArticolo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contenuto: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gallery: Schema.Attribute.Media<
      ...
      true
    >;
    immagine_principale: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    pubblicato: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBigliettoBiglietto extends Struct.CollectionTypeSchema {
  collectionName: 'bigliettos';
  info: {
    displayName: 'Biglietto';
    pluralName: 'bigliettos';
